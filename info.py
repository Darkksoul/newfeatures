...
USERNAME = environ.get('USERNAME', 'https://telegram.me/DevilServers')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001894162257'))
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/hNt.jpg')
PICS = environ.get('PICS', 'https://te.legra.ph/file/155f5cc22394659205dfd.jpg')

#this vars is for when heroku or koyeb acc get banned, then change this vars as your file to link bot name
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001894162257'))
URL = environ.get('URL', '')

# verify system vars
IS_VERIFY = is_enabled('IS_VERIFY', False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001894162257'))
...
SHORTENER_API = environ.get("SHORTENER_API", "5a4e2c949a57132cd5ab09d7b0df4864eb165a27")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "indiaearnx.com")
SHORTENER_API2 = environ.get("SHORTENER_API2", "5a4e2c949a57132cd5ab09d7b0df4864eb165a27")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "indiaearnx.com")
SHORTENER_API3 = environ.get("SHORTENER_API3", "5a4e2c949a57132cd5ab09d7b0df4864eb165a27")
